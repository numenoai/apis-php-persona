...
/**
 * PersonaNew Class Doc Comment
 *
 * @category Class
 * @description Information needed to create a persona.
 * @package  NumenoPersona
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PersonaNew implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PersonaNew';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PersonaNew., must be smaller than or equal to 256.');
        }
    ...
    public function setBody($body)
    {
        ...
        if ((mb_strlen($body) > 100000)) {
            throw new \InvalidArgumentException('invalid length for $body when calling PersonaNew., must be smaller than or equal to 100000.');
        }
