...
class DefaultApi
{
     ...
     *
     * @param  \NumenoPersona\Model\PersonaNew $persona_new persona_new (required)
     ...
     */
    public function createPersona($persona_new, string $contentType = self::contentTypes['createPersona'][0])
    {
        list($response) = $this->createPersonaWithHttpInfo($persona_new, $contentType);
        return $response;
    }
     ...
     * Create a new Persona
     *
     * @param  \NumenoPersona\Model\PersonaNew $persona_new (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createPersona'] to see the possible values for this operation
     *
     * @throws \NumenoPersona\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function createPersonaWithHttpInfo($persona_new, string $contentType = self::contentTypes['createPersona'][0])
    {
        $request = $this->createPersonaRequest($persona_new, $contentType);
     ...
     */
    public function createPersonaAsync($persona_new, string $contentType = self::contentTypes['createPersona'][0])
    {
        return $this->createPersonaAsyncWithHttpInfo($persona_new, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createPersonaAsyncWithHttpInfo($persona_new, string $contentType = self::contentTypes['createPersona'][0])
    {
        $returnType = '\NumenoPersona\Model\Persona';
        $request = $this->createPersonaRequest($persona_new, $contentType);
     ...
     */
    public function createPersonaRequest($persona_new, string $contentType = self::contentTypes['createPersona'][0])
    {

        // verify the required parameter 'persona_new' is set
        if ($persona_new === null || (is_array($persona_new) && count($persona_new) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $persona_new when calling createPersona'
            );
        }
        ...
        // for model (json/xml)
        if (isset($persona_new)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($persona_new));
            } else {
                $httpBody = $persona_new;
            }
     ...
     * @return void
     */
    public function deletePersona($id, string $contentType = self::contentTypes['deletePersona'][0])
    {
        $this->deletePersonaWithHttpInfo($id, $contentType);
    }
     ...
     */
    public function deletePersonaWithHttpInfo($id, string $contentType = self::contentTypes['deletePersona'][0])
    {
        $request = $this->deletePersonaRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deletePersonaAsync($id, string $contentType = self::contentTypes['deletePersona'][0])
    {
        return $this->deletePersonaAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deletePersonaAsyncWithHttpInfo($id, string $contentType = self::contentTypes['deletePersona'][0])
    {
        $returnType = '';
        $request = $this->deletePersonaRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deletePersonaRequest($id, string $contentType = self::contentTypes['deletePersona'][0])
    {
        ...
        if (!preg_match("/^[a-f0-9]{32}$/", $id)) {
            throw new \InvalidArgumentException("invalid value for \"id\" when calling DefaultApi.deletePersona, must conform to the pattern /^[a-f0-9]{32}$/.");
        }
        

        $resourcePath = '/v1/personas/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     */
    public function getPersonaById($id, string $contentType = self::contentTypes['getPersonaById'][0])
    {
        list($response) = $this->getPersonaByIdWithHttpInfo($id, $contentType);
        return $response;
    }
     ...
     */
    public function getPersonaByIdWithHttpInfo($id, string $contentType = self::contentTypes['getPersonaById'][0])
    {
        $request = $this->getPersonaByIdRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPersonaByIdAsync($id, string $contentType = self::contentTypes['getPersonaById'][0])
    {
        return $this->getPersonaByIdAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPersonaByIdAsyncWithHttpInfo($id, string $contentType = self::contentTypes['getPersonaById'][0])
    {
        $returnType = '\NumenoPersona\Model\Persona';
        $request = $this->getPersonaByIdRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getPersonaByIdRequest($id, string $contentType = self::contentTypes['getPersonaById'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling getPersonaById'
            );
        }
        if (!preg_match("/^[a-f0-9]{32}$/", $id)) {
            throw new \InvalidArgumentException("invalid value for \"id\" when calling DefaultApi.getPersonaById, must conform to the pattern /^[a-f0-9]{32}$/.");
        }
     ...
     * @throws \NumenoPersona\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NumenoPersona\Model\PersonaList|\NumenoPersona\Model\ErrorResponse|\NumenoPersona\Model\ErrorResponse|\NumenoPersona\Model\ErrorResponse|\NumenoPersona\Model\ErrorResponse
     */
     ...
     * @throws \NumenoPersona\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NumenoPersona\Model\PersonaList|\NumenoPersona\Model\ErrorResponse|\NumenoPersona\Model\ErrorResponse|\NumenoPersona\Model\ErrorResponse|\NumenoPersona\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPersonasWithHttpInfo($cursor = null, $limit = 10, string $contentType = self::contentTypes['getPersonas'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\NumenoPersona\Model\PersonaList' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\NumenoPersona\Model\PersonaList' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\NumenoPersona\Model\PersonaList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\NumenoPersona\Model\PersonaList';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\NumenoPersona\Model\PersonaList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getPersonasRequest($cursor = null, $limit = 10, string $contentType = self::contentTypes['getPersonas'][0])
    {
        ...
        if ($cursor !== null && !preg_match("/^[\\x21-\\x7E]{0,1024}$/", $cursor)) {
            throw new \InvalidArgumentException("invalid value for \"cursor\" when calling DefaultApi.getPersonas, must conform to the pattern /^[\\x21-\\x7E]{0,1024}$/.");
        }
     ...
     * @throws \NumenoPersona\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NumenoPersona\Model\Scopes|\NumenoPersona\Model\ErrorResponse
     */
     ...
     * @throws \NumenoPersona\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NumenoPersona\Model\Scopes|\NumenoPersona\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getScopesWithHttpInfo(string $contentType = self::contentTypes['getScopes'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\NumenoPersona\Model\Scopes' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\NumenoPersona\Model\Scopes' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\NumenoPersona\Model\Scopes', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\NumenoPersona\Model\Scopes';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @return \NumenoPersona\Model\Persona|\NumenoPersona\Model\ErrorResponse|\NumenoPersona\Model\ErrorResponse|\NumenoPersona\Model\ErrorResponse|\NumenoPersona\Model\ErrorResponse|\NumenoPersona\Model\ErrorResponse
     */
    public function updatePersona($id, $persona_update, string $contentType = self::contentTypes['updatePersona'][0])
    {
        list($response) = $this->updatePersonaWithHttpInfo($id, $persona_update, $contentType);
        return $response;
    }
     ...
     * @return array of \NumenoPersona\Model\Persona|\NumenoPersona\Model\ErrorResponse|\NumenoPersona\Model\ErrorResponse|\NumenoPersona\Model\ErrorResponse|\NumenoPersona\Model\ErrorResponse|\NumenoPersona\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updatePersonaWithHttpInfo($id, $persona_update, string $contentType = self::contentTypes['updatePersona'][0])
    {
        $request = $this->updatePersonaRequest($id, $persona_update, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updatePersonaAsync($id, $persona_update, string $contentType = self::contentTypes['updatePersona'][0])
    {
        return $this->updatePersonaAsyncWithHttpInfo($id, $persona_update, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updatePersonaAsyncWithHttpInfo($id, $persona_update, string $contentType = self::contentTypes['updatePersona'][0])
    {
        $returnType = '\NumenoPersona\Model\Persona';
        $request = $this->updatePersonaRequest($id, $persona_update, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updatePersonaRequest($id, $persona_update, string $contentType = self::contentTypes['updatePersona'][0])
    {
        ...
        if (!preg_match("/^[a-f0-9]{32}$/", $id)) {
            throw new \InvalidArgumentException("invalid value for \"id\" when calling DefaultApi.updatePersona, must conform to the pattern /^[a-f0-9]{32}$/.");
        }
