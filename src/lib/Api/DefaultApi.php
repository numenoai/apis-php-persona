...
class DefaultApi
{
     ...
     *
     * @param  \NumenoArtRec\Model\PersonaUpdate $persona_update persona_update (required)
     ...
     * @return \NumenoArtRec\Model\Persona|\NumenoArtRec\Model\ErrorResponse|\NumenoArtRec\Model\ErrorResponse|\NumenoArtRec\Model\ErrorResponse|\NumenoArtRec\Model\ErrorResponse
     */
     ...
     * Create a new persona
     *
     * @param  \NumenoArtRec\Model\PersonaUpdate $persona_update (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createPersona'] to see the possible values for this operation
     *
     * @throws \NumenoArtRec\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NumenoArtRec\Model\Persona|\NumenoArtRec\Model\ErrorResponse|\NumenoArtRec\Model\ErrorResponse|\NumenoArtRec\Model\ErrorResponse|\NumenoArtRec\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createPersonaWithHttpInfo($persona_update, string $contentType = self::contentTypes['createPersona'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\NumenoArtRec\Model\Persona' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\NumenoArtRec\Model\Persona' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\NumenoArtRec\Model\Persona', []),
            ...
            $returnType = '\NumenoArtRec\Model\Persona';
     ...
     * @throws \NumenoArtRec\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NumenoArtRec\Model\Persona|\NumenoArtRec\Model\ErrorResponse|\NumenoArtRec\Model\ErrorResponse|\NumenoArtRec\Model\ErrorResponse|\NumenoArtRec\Model\ErrorResponse|\NumenoArtRec\Model\ErrorResponse
     */
     ...
     * @throws \NumenoArtRec\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NumenoArtRec\Model\Persona|\NumenoArtRec\Model\ErrorResponse|\NumenoArtRec\Model\ErrorResponse|\NumenoArtRec\Model\ErrorResponse|\NumenoArtRec\Model\ErrorResponse|\NumenoArtRec\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \NumenoArtRec\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \NumenoArtRec\Model\Personas|\NumenoArtRec\Model\ErrorResponse|\NumenoArtRec\Model\ErrorResponse|\NumenoArtRec\Model\ErrorResponse|\NumenoArtRec\Model\ErrorResponse
     */
     ...
     * @throws \NumenoArtRec\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \NumenoArtRec\Model\Personas|\NumenoArtRec\Model\ErrorResponse|\NumenoArtRec\Model\ErrorResponse|\NumenoArtRec\Model\ErrorResponse|\NumenoArtRec\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPersonasWithHttpInfo($cursor = null, $limit = 10, string $contentType = self::contentTypes['getPersonas'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\NumenoArtRec\Model\Personas' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\NumenoArtRec\Model\Personas' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\NumenoArtRec\Model\Personas', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\NumenoArtRec\Model\Personas';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
